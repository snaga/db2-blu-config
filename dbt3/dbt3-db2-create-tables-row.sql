...
CREATE TABLE supplier (
	...
	s_phone CHAR(15),
	s_acctbal REAL,
	s_comment VARCHAR(101)) organize by row;
...
CREATE TABLE part (
	...
	p_container CHAR(10),
	p_retailprice REAL,
	p_comment VARCHAR(23)) organize by row;
...
CREATE TABLE partsupp (
	...
	ps_availqty INTEGER,
	ps_supplycost REAL,
	ps_comment VARCHAR(199)) organize by row;
...
CREATE TABLE customer (
	...
	c_comment VARCHAR(117)) organize by row;
...
CREATE TABLE orders (
	...
	o_comment VARCHAR(79)) organize by row;
...
CREATE TABLE lineitem (
	...
	l_shipmode CHAR(10),
	l_comment VARCHAR(44)) organize by row;

CREATE TABLE nation (
	n_nationkey INTEGER,
	n_name CHAR(25),
	n_regionkey INTEGER,
	n_comment VARCHAR(152)) organize by row;

CREATE TABLE region (
	r_regionkey INTEGER,
	r_name CHAR(25),
	r_comment VARCHAR(152)) organize by row;
